...
Resources.ResourcesPanel = class extends UI.PanelWithSidebar {
  constructor() {
    ...
    // hotfix: add tip in console panel.
    const resourceTipElement = createElement("div");
    resourceTipElement.className = "resource-view-tip";
    resourceTipElement.innerHTML = "此功能需要平台版本为1040+，手机内容如果有更新，请点击刷新按钮展示更新内容。";
    this.element.insertBefore(resourceTipElement,  this.splitWidget().element)
